...
export default function StudentProfile() {
  ...
  // If profile already has an avatar_path, derive its public URL (public bucket case)
  useEffect(() => {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <input ref={fileRef} type="file" accept="image/*" className="hidden" onChange={async (e) => {
                ...
                setUploading(true);
                try {
                  // Center-crop and resize for consistent circular display
                  let processed = await processAvatarImage(file, 512);
                  ...
                  // Persist avatar_path on profiles (RLS: id = auth.uid())
